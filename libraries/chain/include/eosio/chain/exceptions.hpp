...
#define ACC_ASSERT( expr, exc_type, FORMAT, ... )                \
   FC_MULTILINE_MACRO_BEGIN                                           \
   if( !(expr) )                                                      \
      FC_THROW_EXCEPTION( exc_type, FORMAT, __VA_ARGS__ );            \
   FC_MULTILINE_MACRO_END

#define ACC_THROW( exc_type, FORMAT, ... ) \
 ...
 */
#define ACC_RETHROW_EXCEPTIONS(exception_type, FORMAT, ... ) \
 ...
 * This macro will rethrow the exception as the specified "exception_type"
 */
#define ACC_CAPTURE_AND_RETHROW( exception_type, ... ) \
   catch (eosio::chain::chain_exception& e) { \
...
#define ACC_RECODE_EXC( cause_type, effect_type ) \
