...
//extern uint32_t ACC_TESTING_GENESIS_TIMESTAMP;
...
boost::unit_test::test_suite* init_unit_test_suite(int argc, char* argv[]) {
   ...
   /*
   const char* genesis_timestamp_str = getenv("ACC_TESTING_GENESIS_TIMESTAMP");
   if( genesis_timestamp_str != nullptr )
   {
      ACC_TESTING_GENESIS_TIMESTAMP = std::stoul( genesis_timestamp_str );
   }
   std::cout << "ACC_TESTING_GENESIS_TIMESTAMP is " << ACC_TESTING_GENESIS_TIMESTAMP << std::endl;
   */
   return nullptr;
}
